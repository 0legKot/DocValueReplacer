  ...
  ""CurrencyList"" : {
    ...
    public string convert(long theMoney, long theKopeiki) {
        ...
        do {
            ...
            money2str.Insert(1, triad2Word(theTriad, triadNum, rubSex));
            if (triadNum == 0) {
                money2str.Length--;
                money2str.Append(") ");
